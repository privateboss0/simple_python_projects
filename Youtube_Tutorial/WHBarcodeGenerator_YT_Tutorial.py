...
def barcode_Generate():
    ...
    # Barcode Number 
    barcodeNumber = NumberGenerator() #12 digit
...
# Name the Gui Window 
Generator.title("ProductBarcode Generator")

# size of Gui window 
Generator.geometry('600x600')

#create the generate form and generate button
...
# Price
Price = Label(Generator,text="Price",font=('bold',10))
